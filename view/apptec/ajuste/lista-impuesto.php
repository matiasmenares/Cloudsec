    ...
    <div class="page-content">
        ...
        <div class="page-bar sombra">
            ...
            <div class="page-toolbar">
                <div class="btn-group pull-right">
	                <a class="btn btn-fit-height red-thunderbird" href="agregar-impuesto/"><i class="fa fa-plus-circle"></i> <small> Agregar Impuesto</small></a>
                </div>
            </div>
        </div>
        <!-- END PAGE HEADER-->
		...
		<div class="portlet box blue sombra">
						...
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-barcode"></i>Impuesto
							</div>
							<div class="tools">
...
$(document).ready(function() {    
   $('#cliente').DataTable( {
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?php echo URL_VIEW; ?>/datatable/ajuste/impuesto.php",
            "type": "GET"
        },
        "columns": [
            { "data": 0 },
            ...
            { "data": 2 },
            {
                ...
                {
					return '<a class="btn green fileinput-button" href="detalle-impuesto/'+data+'/">Ver Detalle</a>';
				}
            },
        ]
